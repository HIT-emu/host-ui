#############################################################################
# Makefile for building: hitemu
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  hitemu.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile hitemu.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_NO_DEBUG -DQT_SERIALPORT_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -O2 -Wall -Wextra -fPIC -D_REENTRANT $(DEFINES)
CXXFLAGS      = -pipe -O2 -std=gnu++1z -Wall -Wextra -fPIC -D_REENTRANT $(DEFINES)
INCPATH       = -I. -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtSerialPort -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I. -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = hitemu1.0.0
DISTDIR = /home/ilya/DiskZ/YY_Studcamp/host-ui/.tmp/hitemu1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) /usr/lib/x86_64-linux-gnu/libQt6SerialPort.so /usr/lib/x86_64-linux-gnu/libQt6Core.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = src/batteryengine.cpp \
		src/emdevicecommunicator.cpp \
		src/emulationcontroller.cpp \
		src/main.cpp moc_emdevicecommunicator.cpp \
		moc_emulationcontroller.cpp
OBJECTS       = batteryengine.o \
		emdevicecommunicator.o \
		emulationcontroller.o \
		main.o \
		moc_emdevicecommunicator.o \
		moc_emulationcontroller.o
DIST          = src/mock_device.py \
		...
		hitemu.pro src/TelemetryFrame.h \
		src/batteryengine.h \
		src/emdevicecommunicator.h \
		src/emulationcontroller.h src/batteryengine.cpp \
		src/emdevicecommunicator.cpp \
		src/emulationcontroller.cpp \
		src/main.cpp
QMAKE_TARGET  = hitemu
...
Makefile: hitemu.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/TelemetryFrame.h src/batteryengine.h src/emdevicecommunicator.h src/emulationcontroller.h $(DISTDIR)/
	$(COPY_FILE) --parents src/batteryengine.cpp src/emdevicecommunicator.cpp src/emulationcontroller.cpp src/main.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_emdevicecommunicator.cpp moc_emulationcontroller.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_emdevicecommunicator.cpp moc_emulationcontroller.cpp
moc_emdevicecommunicator.cpp: src/emdevicecommunicator.h \
		src/TelemetryFrame.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/ilya/DiskZ/YY_Studcamp/host-ui/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/ilya/DiskZ/YY_Studcamp/host-ui -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtSerialPort -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/13 -I/usr/include/x86_64-linux-gnu/c++/13 -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-linux-gnu/13/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include src/emdevicecommunicator.h -o moc_emdevicecommunicator.cpp

moc_emulationcontroller.cpp: src/emulationcontroller.h \
		src/emdevicecommunicator.h \
		src/TelemetryFrame.h \
		src/batteryengine.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/ilya/DiskZ/YY_Studcamp/host-ui/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/ilya/DiskZ/YY_Studcamp/host-ui -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtSerialPort -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/13 -I/usr/include/x86_64-linux-gnu/c++/13 -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-linux-gnu/13/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include src/emulationcontroller.h -o moc_emulationcontroller.cpp
...
batteryengine.o: src/batteryengine.cpp src/batteryengine.h \
		src/TelemetryFrame.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o batteryengine.o src/batteryengine.cpp

emdevicecommunicator.o: src/emdevicecommunicator.cpp src/emdevicecommunicator.h \
		src/TelemetryFrame.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o emdevicecommunicator.o src/emdevicecommunicator.cpp

emulationcontroller.o: src/emulationcontroller.cpp src/emulationcontroller.h \
		src/emdevicecommunicator.h \
		src/TelemetryFrame.h \
		src/batteryengine.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o emulationcontroller.o src/emulationcontroller.cpp

main.o: src/main.cpp src/emulationcontroller.h \
		src/emdevicecommunicator.h \
		src/TelemetryFrame.h \
		src/batteryengine.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o src/main.cpp

moc_emdevicecommunicator.o: moc_emdevicecommunicator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_emdevicecommunicator.o moc_emdevicecommunicator.cpp

moc_emulationcontroller.o: moc_emulationcontroller.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_emulationcontroller.o moc_emulationcontroller.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/hitemu/bin || mkdir -p $(INSTALL_ROOT)/opt/hitemu/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/hitemu/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/hitemu/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/hitemu/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/hitemu/bin/ 
